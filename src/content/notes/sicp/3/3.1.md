...
*Exercises*: [3.1](../exercises/31/) [3.2](../exercises/31/) [3.3](../exercises/31/)
...
- We can use the Monte Carlo method to approximate $\pi$, knowing that the probability that two randomly chosen integers have as their GCD is $6/\pi^2$.
...
*Exercises*: [3.5](../exercises/31/) [3.6](../exercises/31/)

## The Costs of Introducing Assignment

- The advantages of local state and assignment come at a price: the substitution model of procedure application from [The Substitution Model for Procedure Application](../../1/11/#the-substitution-model-for-procedure-application) breaks down. We need a more complex model.
...
*Exercises*: [3.7](../exercises/31/) [3.8](../exercises/31/)
